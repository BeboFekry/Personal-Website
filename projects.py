...
st.columns([1,8,1])[1].image("images/test/Logo.png")
...
st.columns([1,1,1])[1].image("images/test/Chat bot-pana.png")
...
st.columns([1,10,1])[1].image("images/test/istockphoto-153070435-612x612(1).jpg")
...
""")
st.columns([1,8,1])[1].image("images/test/types-of-customers(1).png")
...
""")
st.columns([1,8,1])[1].image("images/test/Introducing-a-cat-or-kitten-to-your-dog.png")
...
st.columns([1,8,1])[1].image(r"images/test/2106.i518.013.F.m005.c7.human hands background set.jpg")
...
st.write("The Task is Classification to food type using Deep Learning Computer Vision then identify its calories")
st.columns([1,8,1])[1].image("images/test/Wallpaper.jpg")
...
st.columns([1,8,1])[1].image("images/test/titanic.jpg")
...
st.columns([1,2,1])[1].image("images/test/Business crisis-amico.png")
...
st.columns([1,2,1])[1].image("images/test/House searching-amico.png")
...
st.columns([1,4,1])[1].image("images/test/IMSL What is Regression Model Blog Feature.jpeg")
...
st.columns([1,2,1])[1].image("images/test/Spring flower-rafiki.png")
...
st.columns([1,2,1])[1].image("images/test/decision_tree.png")
...
st.columns([1,2,1])[1].image("images/test/medical.png")
...
st.columns([1,8,1])[1].image("images/test/Sentiment-analysis-HUB-Final.jpg")
...
st.columns([1,8,1])[1].image("images/test/download.png")
...
st.columns([1,8,1])[1].image("images/test/download (1).png")
...
st.columns([1,3,1])[1].image("images/test/handwritten-numbers-vector-260nw-333225059.jpg")
...
# st.info(". Titanic Classification - Easy Building Chatbots and Connect them with Social Media Accounts (Streamlit Project)")
# st.write("""The task is "Titanic Classification", and i need to "Make a system which tells whether the person will be save from sinking. What factors were most likely lead to success-socio-economic status, age, gender and more"
#
# Firstly i have start with data gathering and searching for a suitable dataset, start in read and explore it, i found null values, and some outliers and by using data analysis, visualisation and preprocessing techniques i solve these problems, then starting the modeling process starting with Logistic Regression model and increasing the model complicity till use ensemble learning Random Forest Classifier model architecture which given me the highest test accuracy score by using the Hold-Out cross validation or the train-test-split technique for the evaluation.""")
# st.link_button("GitHub Repository To See Implementation Notebooks and Deployment Codes", "https://github.com/BeboFekry/ChatHub", use_container_width=1)
